 ...
 */
fun TextStyle.withLineHeightPercent(percent: Float): TextStyle {
    return this.copy(lineHeight = fontSize * (percent / 100f))
}
 ...
 */
fun TextStyle.withLetterSpacingPercent(percent: Float): TextStyle {
    return this.copy(letterSpacing = fontSize * (percent / 100f))
}

// Define the typography scale for Someverse app
val SomeverseTypography = Typography(
    // Headings
