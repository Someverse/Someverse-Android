                ...
                Row(
                    ...
                    Button(
                        ...
                        modifier = Modifier
                            .width(128.dp)
                            .height(48.dp),
                        colors = ButtonDefaults.buttonColors(containerColor = type.secondaryButtonColor),
                        shape = RoundedCornerShape(16.dp),
                        elevation = null
                    ) {
                        Text(text = secondaryButtonText, color = type.secondaryButtonTextColor)
                    }
                    ...
                    Button(
                        ...
                        modifier = Modifier
                            .width(128.dp)
                            .height(48.dp),
                        colors = ButtonDefaults.buttonColors(containerColor = type.primaryButtonColor),
                        shape = RoundedCornerShape(16.dp),
                        elevation = null
                    ) {
                        Text(text = primaryButtonText, color = type.primaryButtonTextColor)
                    }
                }
            }
        }
