 ...
 */
@Singleton
class ChatLocalDataSource @Inject constructor() : ChatDataSource {
    ...
    override suspend fun requestChat(userId: Int, message: String): ChatEntity {
    ...
    override suspend fun getChatDetail(roomId: Int): ChatEntity {
        delay(300)
        val chat = chatRooms.find { it.roomId == roomId }
    ...
    override suspend fun sendMessage(
        ...
        if (chatIndex != -1) {
            chatRooms[chatIndex] = chatRooms[chatIndex].copy(
                lastMessage = content,
    ...
    override suspend fun getMessageHistory(
        ...
        val pageMessages = if (startIndex < totalElements) {
